...
static DWORD fd32_imp__GetFileAttributesA(LPCSTR lpFileName)
{
  return INVALID_FILE_ATTRIBUTES;
}

static BOOL fd32_imp__SetFileAttributesA(LPCSTR lpFileName, DWORD dwFileAttributes)
{
  return FALSE;
}
...
static struct symbol kernel32_symarray[] = {
  {"AddAtomA",                    fd32_imp__AddAtomA},
  {"CloseHandle",                 fd32_imp__CloseHandle},
  {"CreateConsoleScreenBuffer",   fd32_imp__CreateConsoleScreenBuffer},
  {"CreateFileA",                 fd32_imp__CreateFileA},
  {"ExitProcess",                 fd32_imp__ExitProcess},
  {"FillConsoleOutputAttribute",  fd32_imp__FillConsoleOutputAttribute},
  {"FillConsoleOutputCharacterA", fd32_imp__FillConsoleOutputCharacterA},
  {"FindAtomA",                   fd32_imp__FindAtomA},
  {"FlushConsoleInputBuffer",     fd32_imp__FlushConsoleInputBuffer},
  {"FlushFileBuffers",            fd32_imp__FlushFileBuffers},
  {"GetAtomNameA",                fd32_imp__GetAtomNameA},
  {"GetCommandLineA",             fd32_imp__GetCommandLineA},
  {"GetConsoleCursorInfo",        fd32_imp__GetConsoleCursorInfo},
  {"GetConsoleMode",              fd32_imp__GetConsoleMode},
  {"GetConsoleScreenBufferInfo",  fd32_imp__GetConsoleScreenBufferInfo},
  {"GetConsoleTitleA",            fd32_imp__GetConsoleTitleA},
  {"GetCurrentProcessId",         fd32_imp__GetCurrentProcessId},
  {"GetCurrentThreadId",          fd32_imp__GetCurrentThreadId},
  {"GetEnvironmentStringsA",      fd32_imp__GetEnvironmentStringsA},
  {"GetFileAttributesA",          fd32_imp__GetFileAttributesA},
  {"GetLargestConsoleWindowSize", fd32_imp__GetLargestConsoleWindowSize},
  {"GetLastError",                fd32_imp__GetLastError},
  {"GetModuleHandleA",            fd32_imp__GetModuleHandleA},
  {"GetNumberOfConsoleMouseButtons", fd32_imp__GetNumberOfConsoleMouseButtons},
  {"GetStartupInfoA",             fd32_imp__GetStartupInfoA},
  {"GetStdHandle",                fd32_imp__GetStdHandle},
  {"GetSystemInfo",               fd32_imp__GetSystemInfo},
  {"GetSystemTimeAsFileTime",     fd32_imp__GetSystemTimeAsFileTime},
  {"GetTickCount",                fd32_imp__GetTickCount},
  {"GetVersionExA",               fd32_imp__GetVersionExA},
  {"GlobalAlloc",                 fd32_imp__GlobalAlloc},
  {"GlobalFree",                  fd32_imp__GlobalFree},
  {"LocalAlloc",                  fd32_imp__LocalAlloc},
  {"LocalFree",                   fd32_imp__LocalFree},
  {"PeekNamedPipe",               fd32_imp__PeekNamedPipe},
  {"QueryPerformanceCounter",     fd32_imp__QueryPerformanceCounter},
  {"ReadConsoleOutputA",          fd32_imp__ReadConsoleOutputA},
  {"ReadFile",                    fd32_imp__ReadFile},
  {"ScrollConsoleScreenBufferA",  fd32_imp__ScrollConsoleScreenBufferA},
  {"SetConsoleActiveScreenBuffer",fd32_imp__SetConsoleActiveScreenBuffer},
  {"SetConsoleCursorInfo",        fd32_imp__SetConsoleCursorInfo},
  {"SetConsoleCursorPosition",    fd32_imp__SetConsoleCursorPosition},
  {"SetConsoleMode",              fd32_imp__SetConsoleMode},
  {"SetConsoleTitleA",            fd32_imp__SetConsoleTitleA},
  {"SetConsoleScreenBufferSize",  fd32_imp__SetConsoleScreenBufferSize},
  {"SetConsoleWindowInfo",        fd32_imp__SetConsoleWindowInfo},
  {"SetEndOfFile",                fd32_imp__SetEndOfFile},
  {"SetErrorMode",                fd32_imp__SetErrorMode},
  {"SetFileAttributesA",          fd32_imp__SetFileAttributesA},
  {"SetFilePointer",              fd32_imp__SetFilePointer},
  {"SetLastError",                fd32_imp__SetLastError},
  {"SetUnhandledExceptionFilter", fd32_imp__SetUnhandledExceptionFilter},
  {"Sleep",                       fd32_imp__Sleep},
  {"VirtualAlloc",                fd32_imp__VirtualAlloc},
  {"VirtualFree",                 fd32_imp__VirtualFree},
  {"WriteConsoleOutputA",         fd32_imp__WriteConsoleOutputA},
  {"WriteFile",                   fd32_imp__WriteFile},
};
